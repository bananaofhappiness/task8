...
class Game:
    ...
    spells = [
            Froze('Заморозка', 'Персонаж атакует врага в рукопашную без ответной атаки', 2),
            Fatality('Фаталити', 'Персонаж добивает врага', 7),
            Invulnerability("Неуязвимость", "Персонаж с большей вероятностью увернется от атаки в течение следующей минуты", 1),
            Chest_Open("Заклинание открытия сундука", "Открывает сундук", 0),
            Swallow("Ласточка", "Здоровье персонажа увеличивается на 20 ХП на 60 секунд", 1),
            Distant_Attack("Огненный заряд", "Персонаж кастует огненный заряд, наносящий урон противнику", 2),
            ]
